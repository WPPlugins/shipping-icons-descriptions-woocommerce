...
Plugin URI: https://wpcodefactory.com/item/shipping-icons-descriptions-woocommerce/
...
final class Alg_WC_Shipping_Icons_Descs {
	...
	function action_links( $links ) {
		...
		if ( 'shipping-icons-descriptions-woocommerce.php' === basename( __FILE__ ) ) {
			$custom_links[] = '<a href="https://wpcodefactory.com/item/shipping-icons-descriptions-woocommerce/">' . __( 'Unlock All', 'shipping-icons-descriptions-woocommerce' ) . '</a>';
		}
	...
	function includes() {
		// Settings
		require_once( 'includes/admin/class-alg-wc-shipping-icons-descriptions-settings-section.php' );
		$settings = array();
		$settings[] = require_once( 'includes/admin/class-alg-wc-shipping-icons-descriptions-settings-general.php' );
		if ( is_admin() && get_option( 'alg_wc_shipping_icons_descs_version', '' ) !== $this->version ) {
		...
		// Core
		require_once( 'includes/class-alg-wc-shipping-icons-descriptions-core.php' );
	}
	...
	function add_woocommerce_settings_tab( $settings ) {
		$settings[] = include( 'includes/admin/class-alg-wc-settings-shipping-icons-descriptions.php' );
		return $settings;
	}
